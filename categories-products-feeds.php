...
//echo '<sitemap>'.PHP_EOL;
    foreach ($products as $prod) {
        ...
        echo '	<SKU>' . $product->sku . '</SKU>' . PHP_EOL;
        ...
        echo '	<condition>new</condition>' . PHP_EOL;
        //echo '	<brand>' . $brand_name . '</brand>' . PHP_EOL;
        echo '	<availability>in stock</availability>' . PHP_EOL;
    }
// echo '</sitemap>'.PHP_EOL;
//echo '</sitemap>'.PHP_EOL;
    echo '</urlset>';
