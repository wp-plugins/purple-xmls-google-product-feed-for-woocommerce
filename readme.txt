...
> **AUTOMATIC** // Once Set up, you can forget it:Added products update the feed instantly!
> **SIMPLE** // It can be configured in less than 2 minutes, and then it works automatically!The plugin includes some great options to create your own customized feed.= Upcoming Features =* Ebay Feed Support* Amazon Feed Support
