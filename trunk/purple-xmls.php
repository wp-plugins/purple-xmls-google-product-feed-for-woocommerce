...
<p>After your attributes and variations are selected and saved, simply select your <em><strong>Product Category</strong></em> and <em><strong>Google Product Category </strong></em>and click "Get Feed" and your in business!</p><br /><h3>Screenshot of updated Admin:</h3><a href="http://www.w3bdesign.ca/woocommerce-google-merchant-feed/"><img style="border:1px #ccc solid;" src="http://www.purpleturtle.pro/wp-content/uploads/2013/07/screenshot-e1373150699517.png" /></a>

<h3><strong>Current Version Information: V2.1 Release Candidate (RC) 2.1.0 &#8211; Attributes and Variable Product Support</strong></h3><br /><a href="http://www.w3bdesign.ca/woocommerce-google-merchant-feed/"><img src="http://rememberingourmagic.com/wp-content/uploads/2013/01/button_upgrade_now.jpg" /></a>';
    echo "<br/>";
    echo "<br/>";
}
