...
class PLicenseKeyDialog {
  ...
  public static function small_registration_dialog($current_licensekey) {
    global $pfcore;
    $result =
	  '
		  <form name="feed_update_delay_form"  action="' . $pfcore->siteHostAdmin . 'admin.php?page=cart-product-feed-admin" id="cat-product-feeds-xml-form" method="post" target="">
		    <table class="form-table">
		    <tbody>
			<tr>
