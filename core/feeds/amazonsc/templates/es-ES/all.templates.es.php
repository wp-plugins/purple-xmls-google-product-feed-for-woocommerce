...
/*** Basic ***/
	...
	$external_product_id_required = !($thisHeaderTemplateType == 'n/a');
	...
	$brandRequired = !($thisHeaderTemplateType == 'sports');
	$this->addAttributeMapping('brand', 'brand_name', true, $brandRequired)->localized_name = 'Brand Name';

	//manufacturer: required by default
	$manufacturerRequired = !($thisHeaderTemplateType == 'sports'); 
	if  ($thisHeaderTemplateType != 'clothing')					 
