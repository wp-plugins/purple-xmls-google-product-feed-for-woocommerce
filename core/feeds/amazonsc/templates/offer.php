...
*/
	...
	$this->addAttributeMapping('', 'leadtime-to-ship', false, false)->localized_name = 'sale-end-date';
	$this->addAttributeMapping('', 'launch-date', false, false)->localized_name = 'leadtime-to-ship'; //handling
