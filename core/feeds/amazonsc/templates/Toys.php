<?php
	...
	$this->addAttributeMapping('part_number', 'part_number',true)->localized_name = 'Manufacturer Part Number';
	...
	$this->addAttributeMapping('','mfg_minimum')->localized_name = 'Minimum Manufacturer Age Recommended'; //positive integer: 12
	$this->addAttributeMapping('','mfg_minimum_unit_of_measure')->localized_name = 'Mfg Minimum Unit Of Measure'; //months or years
