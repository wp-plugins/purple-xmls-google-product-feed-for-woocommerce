<?php
	...
	*/
	...
	$this->addAttributeMapping('part_number', 'part_number', true,true)->localized_name = 'Manufacturer Part Number';
	
	$this->addAttributeMapping('item_package_quantity', 'item_package_quantity',false,false)->localized_name = 'Package Quantity';
