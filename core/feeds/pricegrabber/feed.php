...
class PPriceGrabberFeed extends PBasicFeed {
  ...
  function formatProduct($product) {
		...
		$current_feed['Product Title'] = $product->attributes['title'];
		$current_feed['Categorization'] = $this->current_category;
		$current_feed['Merchant Categorization'] = $product->attributes['product_type'];
		...
		$current_feed['Regular Price'] = sprintf($this->currency_format, $product->attributes['regular_price']);
		if ($product->attributes['has_sale_price'])
			$current_feed['Selling Price'] = sprintf($this->currency_format, $product->attributes['sale_price']);
		else
